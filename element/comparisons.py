...
water_comparisons = {
    ...
    'Earth':
        'Earth either goes with water or stands against it. If there are earth elements that are against you, it’s best'
        'to do as a river does: Gracefully move around or over them. When you’re faced at the foot of a large mountain,'
        'generously ask the earth to move for you. Beautiful scenes can unfold when you two work together. Niagara'
        'Falls, Angel Falls, and Victoria Falls are a few examples of when earth helps lift water to great heights.'
        'Collaborate strategically and kindly with an earth element to keep flowing smoothly.',
    ...
    'Water':
        ...
        'variety from the consistency, you can always intermingle with the other elements. Find a good balance with the'
        'other water element to avoid a drought (too little) or flood (too much).',
...
wind_comparisons = {
    ...
    'Earth':
        'Earth is the opposite of wind, which can help both elements. When you feel like you’re going too much with the'
